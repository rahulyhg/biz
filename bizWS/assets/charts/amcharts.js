            ...
            if (0 < this.gridCountR)
                for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
                    ...
                    if ("radar" == b.type) {
                        ...
                        this.rotate ? "date" == this.type && "middle" == this.gridPosition && (K = -z * this.stepWidth / 2) : "date" == this.type && (h = this.axisWidth - h);
                    f = !1;
                    ...
                    if (!isNaN(v))
                        for (h = 1; h < u; h += v)
                            this.gridAlpha = this.minorGridAlpha, f = p + x * h, f = d.resetDateToMin(new Date(f), A, v, t).getTime(), f = new this.axisItemRenderer(this, (f - this.startTime) * this.stepWidth, void 0, void 0, void 0, void 0, void 0, void 0, void 0, !0), this.pushAxisItem(f);
                    this.gridAlpha = y
                }
        },
...
(function () {
    ...
    d.ValueAxis = d.Class({
        ...
        draw: function () {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)
                ...
                if (this.logarithmic) {
                    ...
                    var r = Math.log(this.max) / Math.LN10 - Math.log(this.fullMin) *
                            Math.LOG10E;
                ...
                var r = Math.round((this.maxCalc - this.minCalc) / this.step) + 1,
                        v;
                !0 === h ? (v = Math.log(this.max) * Math.LOG10E - Math.log(this.minReal) * Math.LOG10E, this.stepWidth = this.axisWidth / v, v > this.logGridLimit && (r = Math.ceil(Math.log(this.max) *
                        Math.LOG10E) + 1, t = Math.round(Math.log(this.minReal) * Math.LOG10E), r > this.gridCountR && (p = Math.ceil(r / this.gridCountR)))) : this.stepWidth = this.axisWidth / (this.max - this.min);
                var y = 0;
        ...
        getMinMax: function () {
            ...
            c = Math.pow(10, Math.floor(Math.log(Math.abs(this.step)) *
                    Math.LOG10E));
            c = d.fixStepE(c);
        ...
        getCoordinate: function (a, b) {
            ...
            !0 === this.logarithmic ? (0 === a && (a = this.treatZeroAs),
                    g = Math.log(a) * Math.LOG10E - Math.log(k) * Math.LOG10E, c = c ? !0 === e ? d - f * g : f * g : !0 === e ? f * g : d - f * g) : c = !0 === e ? c ? d - f * (a - g) : f * (a - g) : c ? f * (a - g) : d - f * (a - g);
        ...
        construct: function (a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            if ("H" == Pa) {
                if (0 <= b && b <= Aa + 1 && (0 < B && 0 < z && b + l <= Aa + 1 && (fa = d.line(y, [b + l, b + l], [0, B], A, z, C), x.push(fa)), 0 < D && (Ba = d.line(y, [b, b + wa, b + wa], [X, X + ma, ma], K, D, C, H), x.push(Ba))), w = 0, G = b, g && 90 == n && I && (G -= r), !1 === e ? (ga = "start", w = "bottom" == Z ? I ? w + B : w - B : I ? w - B : w + B, G += 3, 0 < h && (G += h / 2 - 3, ga = "middle"), 0 < n && (ga = "middle")) : ga = "middle", 1 == ia && 0 < O && !g && !m && da < Aa && (e = d.fitToBounds(b, 0, Aa), da = d.fitToBounds(da, 0, Aa), Y = e - da, 0 < Y && (Da = d.rect(y, Y, a.height, P, O), Da.translate(e - Y + wa, ma), x.push(Da))), "bottom" == Z ? (w += X + r / 2 + ea, I ? (0 < n ? (w = X - ha / 2 * Math.sin(V) - B - 3, a.centerRotatedLabels || (G += ha / 2 * Math.cos(V) - 4 + 2)) : 0 > n ? (w = X + ha * Math.sin(V) - B - 3 + 2, G += -ha * Math.cos(V) - Qa * Math.sin(V) - 4) : w -= B + r + 3 + 3, w -= aa) : (0 < n ? (w = X + ha / 2 * Math.sin(V) + B + 3, a.centerRotatedLabels || (G -= ha / 2 * Math.cos(V))) : 0 > n ? (w = X + B + 3 - ha / 2 * Math.sin(V) + 2, G += ha / 2 * Math.cos(V)) : w += B + u + 3 + 3, w += aa)) : (w += ma + r / 2 - ea, G += wa, I ? (0 < n ? (w = ha / 2 * Math.sin(V) + B + 3, a.centerRotatedLabels || (G -= ha / 2 * Math.cos(V))) : w += B + 3, w += aa) : (0 < n ? (w = -(ha / 2) * Math.sin(V) - B - 6, a.centerRotatedLabels || (G += ha / 2 * Math.cos(V))) : w -= B +
                        r + 3 + u + 3, w -= aa)), "bottom" == Z ? Y = (I ? X - B - 1 : X + u - 1) + ea : (na = wa, Y = (I ? ma : ma - B - u + 1) - ea), f && (G += f), r = G, 0 < n && (r += ha / 2 * Math.cos(V)), ca && (f = 0, I && (f = ha / 2 * Math.cos(V)), r + f > Aa + 2 || 0 > r))
                    ca.remove(), ca = null
            } else {
...
(function () {
    ...
    d.AmGraph = d.Class({
        ...
        createRadarGraph: function () {
            ...
            for (m = this.start; m <= this.end; m++) {
                ...
                if (isNaN(q))
                    ...
                    n.y = t;
                    if (y = this.labelText)
                        y = this.createLabel(n, y), v = 0, r && (v = r.size), this.positionLabel(n, q, t, y, v);
                    isNaN(f) && (f = q);
                    isNaN(g) && (g = t)
                }
            }
        ...
        createSerialGraph: function () {
            ...
            for (L = R; L <= ia; L++) {
                ...
                if (Ia) {
                    ...
                    if ("candlestick" == g || "ohlc" == g)
                        W = Ia.close, Ab = Ia.low, qa = f.getCoordinate(Ab), zb = Ia.high, sa = f.getCoordinate(zb);
                    ta = Ia.open;
                    ...
                    if (!Bb && W < ta || Bb && W < Ba)
                        w.isNegative = !0, Ra && (Na = Ra), Za && (Va = Za), void 0 != Ja && (Ha = Ja);
                    $a = !1;
                    ...
                    switch (g) {
                        case "line":
                            if (isNaN(W))
                                ...
                                if ($a || void 0 != w.lineColor && w.lineColor != this.lineColorSwitched || void 0 != w.fillColors && w.fillColors != this.fillColorsSwitched || !isNaN(w.dashLength))
                                    this.drawLineGraph(x, u, T, U), x = [E], u = [F], T = [], U = [], !Ma || isNaN(M) || isNaN(N) || (T.push(N), U.push(M)), m ? Sa ? (this.lineColorSwitched = Aa, this.fillColorsSwitched = wb) : (this.lineColorSwitched = Ja, this.fillColorsSwitched = Ra) : (this.lineColorSwitched = w.lineColor, this.fillColorsSwitched = w.fillColors), this.dashLengthSwitched = w.dashLength;
                        ...
                        case "step":
                            if (!isNaN(W)) {
                                ...
                                if (1 >= this.periodSpan || 1 < this.periodSpan && E - A > va + Ga)
                                    A = z = NaN;
                                this.drawLineGraph(x, u, T, U);
                                x = [];
                                u = [];
                        ...
                        case "column":
                            ...
                            if (!isNaN(W)) {
                                ...
                                if (ua) {
                                    ...
                                    Q = d.roundTo(Q, 2);
                                    ya.translate(S, Q);
                                    (w.url || this.showHandOnHover) && ya.setAttr("cursor", "pointer");
                                    if (!I) {
                        ...
                        case "candlestick":
                            if (!isNaN(ta) && !isNaN(W)) {
                                ...
                                if (t) {
                                    ...
                                    if (0 === E && 0 === N && 0 === pa && 0 === ra)
                                        continue;
                                    if (E == oa && N == oa && pa == oa && ra == oa)
                                        continue;
                                    Q = F - k / 2;
                                    S = N;
                                    J = k;
                                    ...
                                    if (0 === F && 0 === M && 0 === qa && 0 === sa)
                                        continue;
                                    if (F == Fa && M == Fa && qa == Fa && sa == Fa)
                                        continue;
                                    S = E - k / 2;
                                    Q = M + da / 2;
                                    J = k;
                                    ...
                                    if (S < n && 0 < J) {
                                        ...
                                        !isNaN(sa) && !isNaN(qa) && E < n && 0 < E && (Xa = d.line(h, [E, E], Gb, Ca, X, da), cb = d.line(h, [E, E], Hb, Ca, X, da), d.setCN(a, Xa, this.bcn + "line-high"), w.className && d.setCN(a, Xa, w.className, !0), d.setCN(a, cb, this.bcn + "line-low"), w.className && d.setCN(a, cb, w.className, !0))
                                    }
                                }
            ...
            this.lastDataItem = w;
            if ("line" == g || "step" == g || "smoothedLine" == g)
                "smoothedLine" == g ? this.drawSmoothedGraph(x, u, T, U) : this.drawLineGraph(x, u, T, U), I || this.launchAnimation();
        ...
        createLabel: function (a, b, c) {
            ...
            f && (b = f(a, b));
            if (void 0 !== b && "" !== b)
                return a = d.text(this.container, b, h, e.fontFamily, c), a.node.style.pointerEvents = "none", d.setCN(e, a, this.bcn + "label"), this.bulletSet.push(a), a
        },
                ...
                if ((m = a.graph) && a.catScrollbar) {
                    ...
                    for (t = 0; t < c.length; t++) {
                        var r = c[t].axes[p.id].graphs[m.id].values,
                                v;
                        for (v in r)
                            if (r.hasOwnProperty(v) && "percents" != v && "total" != v) {
                                var y = r[v];
                                y < f && (f = y);
                                y > g && (g = y)
                            }
        ...
        draw: function () {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    this.drop ? (g = C / 1.6, l = 0, "V" == x && (x = "down"), "H" == x && (x = "left"), "down" == x && (D = a + 1, z = b - g - g / 3), "up" == x && (l = 180, D = a + 1, z = b + g + g / 3), "left" == x && (l = 270, D = a + g + g / 3 + 2, z = b), "right" == x && (l = 90, D = a - g - g / 3 + 2, z = b), k = z - H / 2 + 1, m = D - K / 2 - 1, q = d.drop(h, g, l, q, v, r, p, aa)) : 0 < u || 0 === y ? (0 < O && (a = d.rect(h, C, A, q, 0, r +
                ...
                for (K = 0; K < C.length; K++) {
                    ...
                    for (P = 0; P < h.length; P++) {
                        ...
                        if (b.valueAxis.id == H) {
                            ...
                            !b.connect && z && z[O] && 0 < R && B.time - v[O] >= y * R && (z[O].gap = !0);
...
(function () {
    ...
    d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, q, p, t) {
        ...
        if (0 < l) {
            R = " M" + x + "," + (A + l) + " L" + z + "," + (B + l);
            y ? (O || (R += " A" + (b - f) + "," + (l + c - g) + "," + (b + f) + "," + (l + c + g) + "," + z + "," + (B + l) + "," + D + "," + (C + l)), R += " L" + K + "," + (u + l), 0 < k && (O || (R += " B" + (b - k) + "," + (l + c - v) + "," + (b + k) + "," +
                    (l + c + v) + "," + K + "," + (l + u) + "," + x + "," + (l + A)))) : (R += " A" + f + "," + g + ",0," + P + ",1," + D + "," + (C + l) + " L" + K + "," + (u + l), 0 < k && (R += " A" + k + "," + v + ",0," + P + ",0," + x + "," + (A + l)));
            R += " Z";
            var ia = l;
            y && (ia /= 10);
        ...
        if (n) {
            ...
            for (v = 0; v < n.length; v++)
                k.push(d.adjustLuminosity(m.fill, n[v]));
        ...
        createEntry: function (a) {
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (e) {
                    ...
                    (l = b.createMarker(h, f, g, void 0, void 0, void 0, y, l)) && l.translate(q / 2, q / 2)
                }
                ...
                k = b.switchType;
                var x;
                k && "none" != k && 0 < q && ("x" == k ? (x = b.createX(), x.translate(q /
                        2, q / 2)) : x = b.createV(), x.dItem = a, !0 !== a.hidden ? "x" == k ? x.hide() : x.show() : "x" != k && x.hide(), b.switchable || x.hide(), b.addListeners(x, a), a.legendSwitch = x, n.push(x), d.setCN(c, x, "legend-switch"));
                k = b.color;
                a.showBalloon && b.textClickEnabled && void 0 !== b.selectedColor && (k = b.selectedColor);
                b.useMarkerColorForLabels && (k = f);
                ...
                var u;
                f && (f = d.fixBrakes(f), a.legendTextReal = f, u = b.labelWidth, u = isNaN(u) ? d.text(b.container, f, k, c.fontFamily, v, "start") : d.wrappedText(b.container, f, k, c.fontFamily, v, "start", !1, u, 0), d.setCN(c, u, "legend-label"), u.translate(b.lx +
                        p, b.ly), n.push(u), b.labelDx = p, c = u.getBBox().width, b.maxLabelWidth < c && (b.maxLabelWidth = c));
                b.entries[b.index] = n;
                ...
                for (c = 0; c < a.length; c++) {
                    ...
                    if (e)
                        ...
                        if (this.useMarkerColorForLabels) {
                            if (h = f.legendMarker)
                                h.setAttr("fill", n), h.setAttr("stroke", n);
