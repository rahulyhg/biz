...
var nicEditorInstance = bkClass.extend({isSelected: false, construct: function (G, D, C) {
        ...
        if (H || this.options.hasPanel) {
            ...
            var E = {width: "100%", border: "1px solid #ccc", borderTop: 0, overflowY: "scroll", overflowX: "hidden"};
            E["height"] = "400px";
//            E[(B) ? "height" : "maxHeight"] = (this.ne.options.maxHeight) ? this.ne.options.maxHeight + "px" : null;
            ...
            var A = new bkElement("DIV").setStyle({width: "99%", padding: "10px", margin: "4px", Height:"300px !important"}).addClass("main").appendTo(this.editorContain);
            ...
            A.setStyle((B) ? {height: "200px"} : {overflow: "hidden"});
            this.elm = A
        }
...
var nicEditorFontSizeSelect = nicEditorSelect.extend({sel: {1: "1&nbsp;(8pt)", 2: "2&nbsp;(10pt)", 3: "3&nbsp;(11pt)", 4: "4&nbsp;(12pt)", 5: "5&nbsp;(13pt)", 6: "6&nbsp;(14pt)", 7: "7&nbsp;(15pt)", 8: "8&nbsp;(16pt)", 9: "9&nbsp;(17pt)", 10: "10&nbsp;(18pt)", 11: "11&nbsp;(24pt)"}, init: function () {
        this.setDisplay("Font&nbsp;Size...");
        for (itm in this.sel) {
            this.add(itm, '<font size="3">' + this.sel[itm] + "</font>")
        }
    }});
var nicEditorFontFamilySelect = nicEditorSelect.extend({sel: {arial: "Arial", "comic sans ms": "Comic Sans", "courier new": "Courier New", georgia: "Georgia", helvetica: "Helvetica", impact: "Impact", "times new roman": "Times", "trebuchet ms": "Trebuchet", "roboto": "Roboto"}, init: function () {
...
var nicUploadButton = nicEditorAdvancedButton.extend({nicURI: base_url + 'plan/get_niceditimage', errorText: "Failed to upload image", addPane: function () {
